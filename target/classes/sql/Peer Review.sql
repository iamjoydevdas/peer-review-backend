...
CREATE TABLE PEERS (
  ...
  PEER_LNAME VARCHAR(50) NOT NULL,
  PEER_FULL_NAME VARCHAR(101) NOT NULL,
  PEER_DESIG_ID VARCHAR(101) NOT NULL,
  PEER_ROLE_ID VARCHAR(101) NOT NULL,
  PEER_CREATED_BY VARCHAR(50) NOT NULL,
  PEER_CREATION_TS TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PEER_LAST_UPDATED_BY VARCHAR(50) NULL,
  PEER_LAST_UPDATED_TS TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE RATING_SCORES( 
	RATING_SCORE_ID INT(5) AUTO_INCREMENT,
	RATE_ID INT(10),
	SKILL_ID INT(5),
	RATING_SCORE INT(2),
	COMMENT VARCHAR(50),
	CONSTRAINT PK_RATING_SCORE_ID PRIMARY KEY (RATING_SCORE_ID),
	CONSTRAINT FK_RATE_ID FOREIGN KEY (RATE_ID) REFERENCES RATINGS (RATE_ID),
	CONSTRAINT FK_SKILL_ID FOREIGN KEY (SKILL_ID) REFERENCES SKILLS (SKILL_ID)
);

ALTER TABLE RATING_SCORES AUTO_INCREMENT = 1;
...
INSERT INTO SKILLS(SKILL_ID, SKILL_NAME) VALUES (2, 'ORACLE');
INSERT INTO SKILLS(SKILL_ID, SKILL_NAME) VALUES (3, 'ANGULAR');
